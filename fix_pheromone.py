...
average_solutions = solver.solve(ave_graph, colony, limit=3000, gen_size=K, problem=problem)
cnt = 0
...
average_solutions = solver.solve(update_graph, colony, limit=3000, gen_size=K, problem=problem, pheromone_update=True)
cnt = 0
for sol in average_solutions:
    print(sol)
    path = sol.path
